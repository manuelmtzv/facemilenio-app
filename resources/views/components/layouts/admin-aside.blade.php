<aside
       class="fixed w-[70%] top-0 bottom-0 admin-aside ease-in-out duration-200 left-[-100%] bg-gray-50 p-2 lg:0 lg:block lg:static lg:w-auto lg:py-3 lg:bg-transparent overflow-y-auto">
