<aside
       class="fixed w-[60%] top-0 bottom-0 admin-aside ease-in-out duration-200 left-[-100%] bg-gray-50 md:block md:static md:w-auto md:py-3 md:bg-transparent overflow-y-auto">
